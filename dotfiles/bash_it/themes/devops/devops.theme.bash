...
function prompt_command() {
    ...
    if [[ $VIRTUAL_PROMPT_ENABLED == 1 ]]; then
      PS1="\n${yellow}$(ruby_version_prompt) ${blue}$(virtual_prompt_info) ${purple}\u@\H.local ${reset_color}in ${green}\w\n${bold_cyan}$(scm_char)${green}$(scm_prompt_info) ${green}→${reset_color} "
    else
      PS1="\n${yellow}$(ruby_version_prompt) ${purple}\u@\H.local ${reset_color}in ${green}\w\n${bold_cyan}$(scm_char)${green}$(scm_prompt_info) ${green}→${reset_color} "
    fi
}
